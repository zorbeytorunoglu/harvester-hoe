...
internal class BackpackAddCommand: BaseCommand() {

    override val name: String = "add"
    override val permission: String = "harvesterhoe.backpack.add"
    ...
    override fun execute(sender: CommandSender, args: Array<String>): Boolean {
        ...
        Core.services.playerDataService.addHarvestsToBackpack(
            player.uniqueId.toString(), amount
        )

        sender.sendMessage(
            messages.backpackAdd
